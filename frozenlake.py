...
def fun(stats, title):
    ...
    if title == 'q learning':
        plot_reward(reward, episode, 'reward', 'frozenlake: number of iterations vs reward: ' + title)
        plot_reward(error, episode, 'error', 'frozenlake: number of iterations vs error: ' + title)
        plot_reward(time, episode, 'time', 'frozenlake: number of iterations vs time: ' + title)
    else:
        plot_graph(time, 'number of iterations', 'time', 'frozenlake: number of iterations vs time: ' + title)
        plot_graph(error, 'number of iterations', 'error', 'frozenlake: number of iterations vs error: ' + title)
        plot_graph(reward, 'number of iterations', 'reward', 'frozenlake: number of iterations vs reward: ' + title)
...
if __name__ == '__main__':
    ...
    plt.title('frozenlake : number of iterations vs error : q learning')
